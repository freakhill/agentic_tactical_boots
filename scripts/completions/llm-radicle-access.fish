...
complete -c llm-radicle-access -n '__fish_use_subcommand' -a 'create-identity bootstrap-config list-identities retire-identity retire-expired bind-repo list-bindings unbind-repo print-env here tui help'
complete -c llm-radicle-access -n '__fish_seen_subcommand_from here' -a 'info bind unbind list-bindings'
