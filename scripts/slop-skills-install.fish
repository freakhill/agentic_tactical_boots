...
function __install_skills_help
    echo "slop-skills-install — copy repo skills into ~/.claude/skills"
    echo ""
    echo "Description:"
    ...
    echo ""
    echo "Usage:"
    echo "  scripts/slop-skills-install.fish [--force] [--dry-run]"
    echo "  scripts/slop-skills-install.fish help"
    echo ""
    echo "Options:"
    ...
    echo "Examples:"
    echo "  # Preview"
    echo "  scripts/slop-skills-install.fish --dry-run"
    echo ""
    echo "  # Install (skip existing)"
    echo "  scripts/slop-skills-install.fish"
    echo ""
    echo "  # Replace existing skills with the in-repo versions"
    echo "  scripts/slop-skills-install.fish --force"
    echo ""
    echo "Notes:"
